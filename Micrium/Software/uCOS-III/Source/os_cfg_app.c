...
CPU_STK        OSCfg_IdleTaskStk0   [OS_CFG_IDLE_TASK_STK_SIZE];
CPU_STK        OSCfg_IdleTaskStk1	[OS_CFG_IDLE_TASK_STK_SIZE];
CPU_STK        OSCfg_IdleTaskStk2	[OS_CFG_IDLE_TASK_STK_SIZE];
CPU_STK        OSCfg_IdleTaskStk3	[OS_CFG_IDLE_TASK_STK_SIZE];
...
CPU_STK      * const  OSCfg_IdleTaskStkBasePtr0   = (CPU_STK    *)&OSCfg_IdleTaskStk0[0];
...
CPU_STK      * const  OSCfg_IdleTaskStkBasePtr3 = (CPU_STK    *)&OSCfg_IdleTaskStk3[0];
...
CPU_INT32U     const  OSCfg_IdleTaskStkSizeRAM   = (CPU_INT32U  )sizeof(OSCfg_IdleTaskStk0);
...
void  OSCfg_Init (void)
{
    ...
    (void)&OSCfg_IdleTaskStkBasePtr0;
	(void)&OSCfg_IdleTaskStkBasePtr1;
	(void)&OSCfg_IdleTaskStkBasePtr2;
	(void)&OSCfg_IdleTaskStkBasePtr3;
