...
typedef struct cpu_stat {
	//DWORD CPU_Num;					//CPU内核号
	OS_TCB* CPU_CurTask_TCB;			//当前内核上运行的任务

}CPU_STAT;
OS_EXT CPU_STAT* CPU_STATS[4];
OS_EXT CPU_STAT temp0;
OS_EXT CPU_STAT temp1;
OS_EXT CPU_STAT temp2;
OS_EXT CPU_STAT temp3;
...
OS_EXT            OS_TCB                    OSIdleTaskTCB0;
OS_EXT            OS_TCB                    OSIdleTaskTCB1;
OS_EXT            OS_TCB                    OSIdleTaskTCB2;
OS_EXT            OS_TCB                    OSIdleTaskTCB3;
...
OS_EXT            OS_CTR                    OSTmrUpdateCtr;
                                                                        ...
                                                                        /* TCBs ------------------------------------- */
OS_EXT            OS_TCB                   *OSTCBCurPtr[4];                /* Pointer to currently running TCB           */
...
extern  CPU_STK     * const OSCfg_IdleTaskStkBasePtr0;
extern  CPU_STK     * const OSCfg_IdleTaskStkBasePtr1;
extern  CPU_STK     * const OSCfg_IdleTaskStkBasePtr2;
extern  CPU_STK     * const OSCfg_IdleTaskStkBasePtr3;
